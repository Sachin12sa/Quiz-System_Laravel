...
<body class="bg-gray-200 min-h-screen flex flex-col items-center justify-center gap-6">
    ...
    <div class=" justify-between w-200">
        <a href="{{url()->previous()?? '/'}}"class="no-print bg-indigo-700 hover:bg-indigo-800 text-white px-6 py-2 rounded-lg shadow font-semibold mr-115">  ＜ Back</a>       
        <a href="/download-certificate" class="no-print bg-indigo-700 hover:bg-indigo-800 text-white px-6 py-2 rounded-lg shadow font-semibold"> ⬇ Download Certificate</a>
 </div>
    ...
    <div id="certificate"
        ...
        <div class="text-center mt-10">
            <h2 class="text-5xl font-bold text-gray-800  capitalize">
                {{$data['name']}}
            </h2>
        </div>
